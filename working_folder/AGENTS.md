...
- I (the user) will usually talk to you in Estonian.
- You must ALWAYS answer **to me** in ESTONIAN, unless I explicitly ask you to answer in another language.

- All CODE must be in ENGLISH by default:
  ...
  - error messages
  - log messages
  - UI texts (buttons, labels, headings, toasts, dialogs)
  - API payloads (titles, descriptions, etc.)

- When I give you UI text or error message in Estonian, you must:

  1. first translate it into natural English,
  2. then use the ENGLISH version in the code.

- NEVER put Estonian text directly into the app or API unless I say very clearly something like:

  - "kasuta eesti keelt rakenduses"
  - "see tekst peab olema eesti keeles"

- If you are unsure whether some text belongs to “chat with user” or “app UI / code”, ASK a short clarification instead of guessing.
